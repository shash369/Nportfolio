...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+91)7355102285",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "shashwatforschol@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "Basti, Uttar Pradesh",
  },{
    icon: <FaLinkedin  />,
    title: "linkedin",
    description: "https://www.linkedin.com/in/shashwat-shukla-a43146261/",
  },
];
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_3glglgbh", // Replace with your service ID
        "template_litnutgr", // Replace with your template ID
        form.current,
